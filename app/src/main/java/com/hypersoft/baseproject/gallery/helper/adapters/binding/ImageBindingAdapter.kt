package com.hypersoft.baseproject.gallery.helper.adapters.binding
...
fun ShapeableImageView.isSelected(isSelected: Boolean) {
    if (isSelected)
        this.setImageResource(R.drawable.ic_check)
    else
        this.setImageResource(R.drawable.ic_uncheck)
}